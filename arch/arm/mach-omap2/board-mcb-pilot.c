/*
 * linux/arch/arm/mach-omap2/board-mcbc-pilot.c
 */
...
#define RESERVE_2		99
#define I2C_REQ	  		101	// Master select 0 (default) is BC, 1 is omap
#define I2C_ACK			100	// I2C bus granted
#define I2C_INT			102	// Interupt line from BC
...
static void mcb_export_gpio(void) {
	...
	config_gpio_in(I2C_INT, OMAP_PIN_INPUT_PULLDOWN, "BC_IRQ");
...
static int __init mcb_i2c_init(void) {
	...
	if (gpio_get_value(I2C_ACK) == 0)
		...
		mcb_i2c3_boardinfo[0].irq = gpio_to_irq(I2C_INT);
